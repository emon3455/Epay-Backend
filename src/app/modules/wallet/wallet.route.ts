...
// USER
router.post("/add-money", checkAuth(Role.USER, Role.ADMIN, Role.SUPER_ADMIN),validateRequest(addMoneyZodSchema), WalletController.addMoney);
router.post("/withdraw-money", checkAuth(Role.USER, Role.AGENT), validateRequest(withdrawMoneyZodSchema), WalletController.withdrawMoney);
