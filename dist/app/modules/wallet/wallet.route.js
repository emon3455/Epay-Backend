...
// USER
router.post("/add-money", (0, checkAuth_1.checkAuth)(user_interface_1.Role.USER), (0, validateRequest_1.validateRequest)(wallet_validation_1.addMoneyZodSchema), wallet_controller_1.WalletController.addMoney);
router.post("/withdraw-money", (0, checkAuth_1.checkAuth)(user_interface_1.Role.USER), (0, validateRequest_1.validateRequest)(wallet_validation_1.withdrawMoneyZodSchema), wallet_controller_1.WalletController.withdrawMoney);
